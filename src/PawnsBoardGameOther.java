...
import viewOther.adabters.IGUIViewToPawnsBoardGuiView;

/**
 * Creates a new pawns board game with GUI interface for testing.
 */
public final class PawnsBoardGameOther {
  ...
  public static void main(String[] args) {
    ...
    PawnsBoardGuiView viewBlue = new IGUIViewToPawnsBoardGuiView(model, PlayerColor.BLUE);
